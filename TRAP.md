# True Readiness Audit Prompt (TRAP) — v2.0.0
...
**Backend** — validation, sanitization, logging hygiene, secrets handling, error handling, CORS, CSRF, SSRF, RCE, insecure deserialization, command execution.
